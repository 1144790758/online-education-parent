...
import com.lhl.eduService.EduApp;
...
public class TestCode {
    ...
    //测试注解开发dao,可行,但是要加上@Mapper注解
    @Test
    public void testMapper(){
        System.out.println(mapper);
        List<EduTeacher> findall = mapper.findall();
    ...
    public void main1() {
        ...
        gc.setOutputDir("F:\\IDEA Projects\\online-education-parent\\online-education-service\\service-statistics" + "/src/main/java");
        gc.setAuthor("lhl");
...
//        pc.setModuleName("serviceComment"); //模块名
        pc.setParent("com.lhl.commentService");
